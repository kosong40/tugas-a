...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pelayanans')->insert([
            ...
            // ['pelayanan'=>"$sk (Izin Pariwisata)",'jenis_pelayanan'=>"$ter",'slug'=>slug($sk)],
            // ['pelayanan'=>"$rm (Izin Pariwisata)",'jenis_pelayanan'=>"$ter",'slug'=>slug($rm)],
            // ['pelayanan'=>"$gk (Izin Pariwisata)",'jenis_pelayanan'=>"$ter",'slug'=>slug($gk)],
            // ['pelayanan'=>"$aw (Izin Pariwisata)",'jenis_pelayanan'=>"$ter",'slug'=>slug($aw)],
